// Definição das 8 tools de function calling para o agente SDR.
// Porta 1:1 de supabase/functions/_shared/claude-tools.ts.
...
export const AI_TOOLS: Tool[] = [
  ...
  },
  {
    ...
    input_schema: {
      type: 'object',
      properties: {
        delay_hours: { type: 'number', description: 'Horas para aguardar antes de enviar o follow-up (padrão: 24)' },
        context: {
          type: 'string',
